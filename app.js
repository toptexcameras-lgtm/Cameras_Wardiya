...
// Holiday Names (Egyptian Official Holidays)
const HOLIDAY_NAMES = {
  "08/01/2026": "عيد الميلاد المجيد (الكريسماس) 🎄",
  "29/01/2026": "عيد الميلاد المجيد (الكنيسة الأرثوذكسية) ✝️",
  "19/03/2026": "عيد شم النسيم 🌸",
  "26/03/2026": "عيد القيامة المجيد (شندي) ✝️",
  "16/04/2026": "عيد الفطر المبارك 🌙",
  "30/04/2026": " شم النسيم يوم الاتنين 🌿",
  "28/05/2026": "عيد تحرير سيناء 🦅",
  "18/06/2026": "عيد الأضحى المبارك 🐑",
  "02/07/2026": "رأس السنة الهجرية 🌙",
  "23/07/2026": "ثورة 23 يوليو 🇪🇬",
  "27/08/2026": "المولد النبوي الشريف ☪️",
  "08/10/2026": "عيد القوات المسلحة ⚔️"
};
...
function getWeekRotation(weekIndex){
  ...
  // 🆕 New rotation starting from week index 14 (11/04/2026)
  const NEW_ROTATION_START = 14;
  if(weekIndex >= NEW_ROTATION_START){
    const rotationIndex = (weekIndex - NEW_ROTATION_START) % 3;
    const rotations = [
